...
use massive_geometry::{
    Camera, DepthRange, Matrix4, PerspectiveDivide, Plane, Point, Ray, SizePx, Vector3, Vector4,
};
...
impl RenderGeometry {
    pub fn new(surface_size: SizePx, camera: Camera) -> Self {
        Self {
            surface_size,
            camera,
            head_version: 1,
    ...
    fn pixel_matrix(surface_size: SizePx) -> Matrix4 {
