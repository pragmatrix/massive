...
- Carry out computations as precisely as possible: only when needed, and at the narrowest branch where their result is consumed. Apply the same rule to writes and updates.
