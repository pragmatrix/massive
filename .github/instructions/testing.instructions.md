...
- During bugfix work, follow the `bugfix` skill: create a focused failing test first when practical, verify it fails for the right reason, then implement the fix and confirm the test passes.
