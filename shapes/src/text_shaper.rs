...
use cosmic_text::{
    Attrs, AttrsList, BufferLine, CacheKey, Family, FontSystem, LayoutGlyph, LayoutLine,
...
impl<'a> TextShaper<'a> {
    ...
    pub fn shape(self, font_system: &mut FontSystem, font_size: f32) -> Option<GlyphRun> {
